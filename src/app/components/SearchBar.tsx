...
const SearchBar: React.FC = () => {
  return (
    <div className="search__background bg-[#fff] border-b-[#e1e7ea] h-[80px] z-[1]">
      <div className="search__wrapper relative flex items-center justify-between px-8 max-w-[1070px] mx-auto h-full">
        ...
        <div className="search__content flex items-center gap-6 max-w-[340px] w-full">
          ...
          <button className="sidebar__toggle-btn hidden sm:flex items-center justify-center cursor-pointer">
